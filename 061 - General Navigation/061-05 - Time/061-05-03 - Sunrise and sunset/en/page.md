...
1.  **Atmospheric Refraction:** The atmosphere acts as a lens that bends light. This allows us to see the Sun a few minutes before it geometrically rises above the horizon and a few minutes after it has set.
2.  **Observer Altitude:** At greater height, the visible horizon is farther away and "lower". This means that, if you are flying high or on a mountain, you will see sunrise **earlier** and sunset **later** than someone who is at sea level.

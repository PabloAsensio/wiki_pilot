---
title: "Humidity"
description: "Understand humidity concepts for aviation: relative humidity (RH), dew point, mixing ratio, and their formulas for meteorology exams."
...
*   **Exact Formula (based on Mixing Ratio):**
...
1.  **Add water vapor** (e.g., evaporation of rain).
2.  **Cool the air** (e.g., adiabatic ascent, nocturnal radiation cooling).

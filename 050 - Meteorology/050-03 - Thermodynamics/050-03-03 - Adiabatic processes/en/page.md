...
description: "Clear explanation of adiabatic processes, lapse rates (DALR and SALR), and atmospheric stability for aviation meteorology exams."
...
| **Neutral Stability** | **ELR = DALR** (dry) <br> **ELR = SALR** (saturated) | The parcel has the same temperature as the environment and tends neither to rise nor fall. |

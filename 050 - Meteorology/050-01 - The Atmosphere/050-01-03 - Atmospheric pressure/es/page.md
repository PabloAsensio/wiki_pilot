...
*   **Dorsal (Ridge)**: Una extensión alargada de un área de alta presión. Asociada con **buen tiempo** y aire cálido/seco.
*   **Vaguada (Trough)**: Una extensión alargada de un área de baja presión. Asociada con aire frío, nubes y **precipitación**.
*   **Collado (Col)**: Área de presión neutra entre dos altas y dos bajas.

## Variación de la Presión con la Altitud

La presión disminuye con la altitud de forma no lineal (exponencial). La tasa de disminución es mayor cerca del suelo y menor a gran altitud.

*   **Nivel del Mar**: 1 hPa ≈ 27-30 ft.
*   **18,000 ft (5,500 m)**: La presión es aprox. **500 hPa** (la mitad de la presión a nivel del mar). Aquí, 1 hPa ≈ 50 ft.
*   **39,000 ft**: 1 hPa ≈ 105 ft.

### Niveles de Presión Estándar (ISA)
Relación aproximada entre Niveles de Vuelo (FL) y Presión:
...
*(Nota: Si la estación está por debajo del nivel del mar, la relación se invierte).*

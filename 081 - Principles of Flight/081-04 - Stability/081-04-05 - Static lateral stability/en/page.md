...
description: "Stability around the longitudinal axis (Roll). Dihedral effect."
...
1.  **Dihedral**: Upward angle of wings. When sideslipping, the lower wing has a higher effective Angle of Attack than the upper wing -> More Lift -> Restoring Roll.
2.  **Sweepback**: The lower wing (advancing into the relative wind due to sideslip) presents a greater span/less sweep to the airflow -> More Lift -> Restoring Roll.
3.  **High Wing vs Low Wing**:

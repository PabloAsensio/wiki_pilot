...
*   **Condition**: The longer of:
    1.  **OEI (One Engine Inoperative)**: Distance with critical engine failure at $V_{EF}$ (just before $V_1$).
    2.  **AEO (All Engines Operating)**: Distance with all engines operating $\times 1.15$.
...
*   **Condition**: The longer of:
    1.  **OEI**: Stop with one engine failed and reverse thrust (if credited, usually not on dry runway).
    2.  **AEO**: Stop with all engines operating (Rejected Take-off for other reasons).

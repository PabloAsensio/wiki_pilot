...
## Types of Magnetism
1.  **Hard Iron Magnetism:** Permanent magnetism acquired by the aircraft's steel components during manufacture or due to lightning strikes/maintenance. It is relatively constant.
2.  **Soft Iron Magnetism:** Temporary magnetism induced in the aircraft's structure by the Earth's field. It changes as the aircraft changes heading or latitude.
...
To convert between headings, use the mnemonic **C-D-M-V-T**:
**C**ompass $\pm$ **D**eviation = **M**agnetic $\pm$ **V**ariation = **T**rue.
*(East is Plus, West is Minus when going Left $\rightarrow$ Right).*

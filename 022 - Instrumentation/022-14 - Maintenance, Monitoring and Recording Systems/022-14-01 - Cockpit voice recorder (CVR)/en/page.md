...
*   **Components**:
    *   **Area Microphone**: Typically located in the overhead panel to capture general cockpit sounds (switches, alerts, conversations).
...
3.  **Interphone**: Communications between flight crew members.
4.  **Navigation Aids**: Audio idents (Morse code) from nav radios.
5.  **Public Address (PA)**: Announcements made by the flight crew.

*   *Note*: It does **not** typically record communications between flight attendants (inter-cabin stations) unless they call the cockpit.

...
*   **CPU (Unidad Central de Procesamiento)**: El "cerebro" del ordenador.
    ...
    *   **Unidad de Control**: Gestiona la temporización y la secuenciación.
    *   **Registros**: Memoria pequeña y de alta velocidad para procesamiento inmediato.
*   **Memoria**:
    *   **RAM** (Memoria de Acceso Aleatorio): Volátil (se pierde al apagar la energía), lectura/escritura rápida.
...
*   **Función**:
    ...
    *   **Bus Externo**: Conecta el ordenador a **Periféricos** externos (Sensores, Pantallas, Impresoras, Teclados).
